...
L.Settings.LoadConditionContentTypeLabels = {
	...
	[Private.Enum.ContentType.Dungeon] = "Calabozo",
...
L.Settings.FrameHeightLabel = "Alto"
...
L.Settings.TickWidthLabel = "Ancho de la marca"
...
L.Settings.FeatureFlagSettingTitles = {
	[Private.Enum.FeatureFlag.ShowIcon] = "Para más información, pasa el cursor sobre «Funciones» a la izquierda",
...
do
	...
	L.Settings.FeatureFlagTooltip = table.concat({
		...
		CreateFeatureFlagTooltip(
			...
			"Reproduce el texto a voz «foco» (u «objetivo») cuando la unidad observada desaparece, como recordatorio para elegir una nueva. ¡Solo en calabozos!"
		),
		CreateFeatureFlagTooltip(
			Private.Enum.FeatureFlag.PlayTTSOnCastStart,
			string.format(
				"Reproduce «%s» en texto a voz cuando la unidad observada empieza a lanzar. Incondicional, no puede verificar si puedes interrumpir o si es interrumpible. ¡Solo en calabozos!",
