...
local provider = {region='US',realm='Archimonde',name='US',type='subscribers',zone=46,date='2026-06-20',data={As='Aspir:BAEALgAECggJCAABLgAFFAcJGAABABwWAA==.',Da='Daddio:BAEALgADCgIJAwABLgADCgcJBwACAAAAAA==.',Li='Linthori:BAEALgADCgMJAwABLgAECgcJDQACAAAAAA==.',Ne='Nelson:BAEALgAECgYJCAABLgAECgkJLQADAFEeAA==.',Or='Ori:BAEALgADCgcJCwABLgAECgcJDQACAAAAAA==.',Ph='Philsner:BAEALgAECgcJDQAAAA==.',},}
