...
local provider = {region='US',realm='Archimonde',name='US',type='subscribers',zone=46,date='2026-08-11',data={As='Aspir:BAEALgAECggJCAABLgAFFAgJGQABAIATAA==.',Da='Daddio:BAEALgAECgQJBAABLgADCgcJBwACAAAAAA==.',Li='Linthori:BAEALgADCgMJAwABLgAECgcJDQACAAAAAA==.',Ne='Nelson:BAEALgAECgYJCAABLgAECgkJLQADAFEeAA==.',Or='Ori:BAEALgADCgcJCwABLgAECgcJDQACAAAAAA==.',Ph='Philsner:BAEALgAECgcJDQAAAA==.',},}
