...
local heroicData = {
    ...
    abilities = {
        ...
        {name = "Ravenous Feast", spellID = 1290516, category = "group soak", phase = 1, times = {67.86, 69.86, 71.36, 135.63, 137.63, 139.13, 237.36, 239.36, 240.86, 305.15, 307.15, 308.65, 406.81, 408.81, 410.31, 474.58, 476.58, 478.08}, duration = 0},
...
local mythicData = {
    ...
    abilities = {
        ...
        {name = "Ravenous Feast", spellID = 1290516, category = "group soak", phase = 1, times = {61.27, 63.27, 64.77, 122.28, 124.28, 125.78, 216.31, 218.31, 219.81, 277.35, 279.35, 280.85, 371.36, 373.36, 374.86, 432.4, 434.4, 435.9}, duration = 0},
