...
local function BuildUI()
    ...
    -- Blizzard API Limit Warning (move to top right, styled box)
    local warnBox = CreateFrame("Frame", nil, f, "BackdropTemplate")
    warnBox:SetSize(340, 100)
    warnBox:SetPoint("TOPRIGHT", f, "TOPRIGHT", -24, -82)
    ...
    warn:SetMaxLines(6)
    warn:SetText("|cffff4444Blizzard now limits world marker placement/clearing to 3 per second. If you try to place or clear more than 3 markers per second, some will be ignored or delayed. This is a Blizzard restriction and cannot be bypassed. The addon will now throttle marker commands to avoid hitting this limit.|r")
